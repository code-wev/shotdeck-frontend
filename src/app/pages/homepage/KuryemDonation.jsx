...
<h4 className='text-white birthstone  text-center mt-8 text-lg'    style={{ textShadow: '0 4px 6px rgba(0,0,0,2)' }} >None for the moment, be the first to help the project !!!</h4>

<div className='birthstone'>
    <h4   style={{ textShadow: '0 4px 6px rgba(0,0,0,1)' }} className='text-3xl mt-4 '>GOLD:</h4>
    <div className='flex justify-between text-[#00A1FF]' 
...
<h4 className='text-white birthstone text-4xl text-center mt-3'    style={{ textShadow: '0 4px 6px rgba(0,0,0,1)' }} >Let’s build something together</h4>
...
<div>
 ...
 <div className='text-center py-4'>
    ...
    <div className='birthstone text-center text-2xl'>
        ...
        <li>
{`Bronze > 1€ : Name on website`}
</li>

<li>{`Silver > 5€ : Specialities next to your name on website`}</li>
<li>{`Gold > 10€ : Linkedin or Portfolio link on website`}</li>
    </div>
        <p className='encode-only mt-6 text-center'>This website is here for the FX community, free for everyone — but it does cost time and money to keep it running.
If it has helped you, consider supporting it by donating.
Your support helps keep it alive.</p>
...
<h4 className='text-white birthstone text-xl text-center mt-12'    style={{ textShadow: '0 4px 6px rgba(0,0,0,1)' }} >None for the moment, be the first to help the project !!!</h4>
{/* button */}
<section>
    <div className='flex gap-4 overflow-hidden justify-between mt-6'>

    <Image src={image1} className='w-24 h-24'/>
    <Image src={image2} className='w-24 h-24' />
    <Image src={image4} className='w-24 h-24'/>
</div>


<div className='flex mt-6 justify-between'>
        <Image src={image3} className='w-44 h-24'/>
    <Image src={image5} className='w-24 h-24' />
</div>

<div className='flex justify-center mt-6'>

    <Image src={image6} className='w-24 h-24'  />
</div>
</section>
</div>
